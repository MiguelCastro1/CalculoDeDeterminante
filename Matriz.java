...
class Matriz_avancado {

    private int [][] Matriz;
    private int Colunas;
    private int Linhas;

    Matriz_avancado(int ordem) {
    ...
    public void CopiaMatrizPraMenor(Matriz MatA, Matriz MatB, int not_i, int not_j) {
    ...
    // implementacao do teorema de  Sarrus
    ...
    public void copiaMatrizMaiorParaMenor(Matriz maior, Matriz menor, int isqn, int jsqn) {
        ...
        contAi = 0;
        for (contBi = 0; contBi < this.Linhas; contBi++) {
            if (contAi == isqn) {
                contAi++;
            }
            contAj = 0;
            for (contBj = 0; contBj < this.Colunas; contBj++) {
                if (contAj == jsqn) {
                    contAj++;
                }
    ...
    //retorna indice da colunas com mais zeros
